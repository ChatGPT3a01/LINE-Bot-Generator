...
| 模型 | 優勢 | 適用場景 |
|------|------|----------|
| **Gemini 3.5 Flash** | 快速、經濟、繁體中文佳 | 一般客服對話 |
| **Gemini 3.1 Pro** | 理解力強、推理佳 | 複雜問答 |
| **GPT-5.6 Terra** | 邏輯推理、英文佳 | 技術支援 |
| **GPT-5.6 Terra** | 進階理解力 | 專業諮詢 |
| **GPT-5.6 Terra** | 最新最強 | 高階應用 |
...
### Google Gemini
- **Gemini 3.5 Flash**：快速、經濟，適合一般對話
- **Gemini 3.1 Pro**：進階、強大，適合複雜任務
- **Gemini 3.0 Flash**：新一代快速模型
- **Gemini 3.0 Pro**：新一代專業模型

### OpenAI GPT
- **GPT-5.6 Terra**：標準版，平衡效能與成本
- **GPT-5.6 Terra**：進階版，更佳理解力
- **GPT-5.6 Terra**：高速版本
- **GPT-5.6 Terra**：最新版，最強大的語言模型
